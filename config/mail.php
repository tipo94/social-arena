...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure email template settings for the AI-Book platform
    |
    */
    ...
    'templates' => [
        ...
        'company_name' => env('MAIL_COMPANY_NAME', 'AI-Book'),
    ...
    */
    ...
    'notifications' => [
        ...
        'delay' => env('MAIL_DELAY', 0),
        'retry_after' => env('MAIL_RETRY_AFTER', 300),
