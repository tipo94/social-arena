...
module.exports = {
  ...
  theme: {
    extend: {
      // Custom brand colors for AI-Book social network
      colors: {
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
      ...
      // Enhanced border radius for modern UI
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
      },
      ...
      boxShadow: {
        ...
        'strong': '0 10px 40px -5px rgba(0, 0, 0, 0.2), 0 25px 50px -12px rgba(0, 0, 0, 0.25)',
